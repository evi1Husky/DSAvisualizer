...
export const ImplementationButton: React.FC<ImplementationButtonProps> = ({ link }) => {

  const [underline, setUnderline] = useState('')
  const [buttonStyle, setButtonStyle]
    = useState(`${css['implementationButtonContainer']}`)
  ...
  return (
    <div className={buttonStyle}
      ...
      onTouchEnd={onLeave}
    >
      <Link className={css['implementationButton']} to={link}>Implementation</Link>
